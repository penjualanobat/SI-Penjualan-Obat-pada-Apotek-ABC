<?php
$nope=$_GET['nope'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_daftar WHERE kode_roti ='$nope'") or die ("SQL Edit error");
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="kode_roti" class="col-sm-3 control-label">Nomor Perkara</label>
                            <div class="col-sm-9">
								<input type="text" name="kode_roti" value="<?=$data['kode_roti']?>" class="form-control" id="inputEmail3" placeholder="Nomor Perkara" readonly="true">
                            </div>
                        </div>
...
if($_POST){
    ...
    $ket=$_POST['ket'];
    //buat sql
    $sql="INSERT INTO peminjaman VALUES ('$kode_roti','$peminjam','$tglPinjam','Belum Kembali','','$ket','')";
	$sqlArsip="UPDATE arsip SET status='Dipinjam' WHERE kode_roti='$nope'";
